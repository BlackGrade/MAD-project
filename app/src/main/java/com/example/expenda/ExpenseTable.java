...
public class ExpenseTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.ctr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ExpenseTable.this,IncomCatergoryActivity.class));
        ...
        ref.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapaterCategory = new AdapaterCategory(ExpenseTable.this,categoryArrayList);
